// Uncomment the line "LibraryProperties->SetLibraryName(...)" and replace "regression_analysis" with desired SystemVue model library name.
...
// 	pLibraryProperties->SetLibraryName( "regression_analysis" );
